...
class RealestatesSpider(scrapy.Spider):
    ...
    start_urls = [
        ...
        # Uncomment to scrape entire DB (change region for each scrape)
        # 'https://www.nepremicnine.net/oglasi-prodaja/pomurska/stanovanje/',
        # 'https://www.nepremicnine.net/oglasi-prodaja/pomurska/hisa/',
        # 'https://www.nepremicnine.net/oglasi-prodaja/pomurska/vikend/',
        # 'https://www.nepremicnine.net/oglasi-prodaja/pomurska/posest/',
        # 'https://www.nepremicnine.net/oglasi-prodaja/pomurska/poslovni-prostor/',
        # 'https://www.nepremicnine.net/oglasi-prodaja/pomurska/garaza/',
        # 'https://www.nepremicnine.net/oglasi-prodaja/pomurska/pocitniski-objekt/',
        # 'https://www.nepremicnine.net/oglasi-oddaja/pomurska/stanovanje/',
        # 'https://www.nepremicnine.net/oglasi-oddaja/pomurska/hisa/',
        # 'https://www.nepremicnine.net/oglasi-oddaja/pomurska/vikend/',
        # 'https://www.nepremicnine.net/oglasi-oddaja/pomurska/posest/',
        # 'https://www.nepremicnine.net/oglasi-oddaja/pomurska/poslovni-prostor/',
        # 'https://www.nepremicnine.net/oglasi-oddaja/pomurska/garaza/',
        # 'https://www.nepremicnine.net/oglasi-oddaja/pomurska/pocitniski-objekt/',
    ]
    ...
    #     "IMAGES_STORE": 'Insert S3 Bucket Name',
    #     "AWS_REGION_NAME": 'us-east-2', # IMPORTANT to insert the correct region for the bucket
    #     "FEED_FORMAT": 'csv',
    ...
    custom_settings = {
        "FEED_FORMAT": 'csv',
        "FEED_URI": '/Users/Squee/Documents/Coding/RealScrape/tmp/nepremicnine_dnevno_{0}.csv'.format(str(date.today())),
        "ITEM_PIPELINES": {'scrapy.pipelines.images.ImagesPipeline': 1},
    }
    ...
    def parse(self, response):
        for add in response.css('div.oglas_container'):
            ...
            request = scrapy.Request(
                a, callback=self.parse_page2, cb_kwargs=dict())
    ...
    def parse_page2(self, response, add_title, type_of_sale, class_of_realestate, type_of_realestate, year_built, size_attribute, add_text, price, image_urls):
        ...
        images = response.css(
            'div.galerija-container a.rsImg::attr(data-rsbigimg)').getall()
        contact_dict = dict()
        index = 1
        for line in contact:
        ...
        region = response.css('div.more_info::text').get()
        m = re.search(r'(?<=\| Regija: )(.*?)(?= \|)', region).group(1)
